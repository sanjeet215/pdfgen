...
public record TenantPrincipal(Long userId, Long tenantId, String displayName, String username,
                              String password, String role, boolean enabled) implements UserDetails {
